...
INSERT INTO "new_UserWord" ("createdAt", "updatedAt", "userId", "wordId") SELECT "createdAt", coalesce("updatedAt", CURRENT_TIMESTAMP) AS "updatedAt", "userId", "wordId" FROM "UserWord";
DROP TABLE "UserWord";
